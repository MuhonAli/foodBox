...
<div class="login-box">
  <div class="login-logo">
    <a href="" style="color: #cf123e;"><b>Admin&nbsp;</b></a>
  </div>
  <!-- /.login-logo -->
...
<?php  if($this->session->flashdata('message')){ echo "<center>".$this->session->flashdata('message')."</center>"; } ?>
    <form method="post" action="<?=base_url()?>Admin">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" style="background: #cf123e;border: #cf123e;" value="Login">Log In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
